...
class SwipeInView: UIView, CAAnimationDelegate {
	...
	convenience init() {
		self.init(frame: CGRect(x: 0, y: 0, width: 174, height: 359))
	}
	...
	func setupHierarchy() {
		...
		__scaling__.bounds = CGRect(x: 0, y: 0, width: 174, height: 359)
		__scaling__.center = CGPoint(x: 87.0, y: 179.7)
		...
		swipeInCircle__root.layer.position = CGPoint(x: 300.448, y: 179.547)
		...
		swipeInArrow__root.layer.position = CGPoint(x: 190.448, y: 179.547)
